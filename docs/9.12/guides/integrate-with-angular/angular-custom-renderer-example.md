...
permalink: /9.12/angular-custom-renderer-example
...
class AppComponent {
  hotSettings: Handsontable.GridSettings = {
    data:
      [
        ['A1', 'https://handsontable.com/docs/9.12/img/examples/professional-javascript-developers-nicholas-zakas.jpg'],
        ['A2', 'https://handsontable.com/docs/9.12/img/examples/javascript-the-good-parts.jpg']
      ],
    columns: [
      {},
      {
