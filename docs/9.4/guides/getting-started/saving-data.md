...
const hot = new Handsontable(container, {
  ...
  afterChange: function (change, source) {
    ...
    ajax('/docs/9.4/scripts/json/save.json', 'GET', JSON.stringify({ data: change }), data => {
...
Handsontable.dom.addEvent(load, 'click', () => {
  ajax('/docs/9.4/scripts/json/load.json', 'GET', '', res => {
...
Handsontable.dom.addEvent(save, 'click', () => {
  ...
  ajax('/docs/9.4/scripts/json/save.json', 'GET', JSON.stringify({ data: hot.getData() }), res => {
