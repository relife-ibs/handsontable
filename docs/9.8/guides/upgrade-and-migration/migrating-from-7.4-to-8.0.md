...
permalink: /9.8/migration-from-7.4-to-8.0
...
![drag_action](/docs/9.8/img/drag_action.svg)
...
![move_action](/docs/9.8/img/move_action.svg)
...
![before_8](/docs/9.8/img/spare_before_8.svg)

The results after:

![after_8](/docs/9.8/img/spare_after_8.svg)
...
![LMB_was](/docs/9.8/img/LMB_was.gif)

Now the expected behavior is to select all cells:

![LMB_is](/docs/9.8/img/LMB_is.gif)
